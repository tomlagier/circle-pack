...
var real__return_number = asm["_return_number"]; asm["_return_number"] = function() {
assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
return real__return_number.apply(null, arguments);
};
...
var _return_number = Module["_return_number"] = function() { return Module["asm"]["_return_number"].apply(null, arguments) };
